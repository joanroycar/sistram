...
<div class="form-group">
    ...
    {!! Form::select('zona_id', $zonas, null, ['class' => 'form-control', 'disabled']) !!}
    ...
    @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre"
                            placeholder="Ingrese El Nombre" value="{{ $paradero->nombre }}" disabled>
                        @error('nombre')
                            <strong class="text-sm text-red-600" style="color: red">{{ $message }}</strong>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="descripcion" class="form-control" id="descripcion" cols="5" rows="5" disabled>{{ $paradero->descripcion }}</textarea>
                    ...
                    <a href="{{ route('paradero.index') }}" class="btn btn-danger" style="float: right">
                        Volver a Listado de Paraderos
                    </a>                   
                </div>
