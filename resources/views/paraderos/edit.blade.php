    ...
    <div class="row">
        <div class="col-sm-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::model($paradero, [
                        'route' => ['paradero.update', $paradero],
                        'method' => 'put',
                        'files' => true,
                        'class' => 'formulario',
                    ]) !!}
    ...
    @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre"
                            placeholder="Ingrese El Nombre" value="{{ $paradero->nombre }}">
                        @error('nombre')
                            <strong class="text-sm text-red-600" style="color: red">{{ $message }}</strong>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="descripcion" class="form-control" id="descripcion" cols="5" rows="5" >{{ $paradero->descripcion }}</textarea>
