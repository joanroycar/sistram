@section('title', 'Módulo Paraderos')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="flex-wrap d-flex justify-content-between align-items-center" style="color: black">
                    ...
                    @can('paradero.create')
                    <div>
                        <a href="{{ route('paradero.create') }}" class="btn btn-primary" style="color: white; border-radius: 12px">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title"> Lista De Paraderos </h4>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                @foreach ($paraderos as $paradero)
                                    <tr>
                                        <td>
                                            ...
                                            <a href="{{ route('paradero.show', $paradero) }}"> <svg width="32"
                                        ...
                                        <td>{{ $paradero->zonas->nombre }}</td>
                                       
                                        <td class="text-center">
                                            <ul class="table-controls">
                                                    <form action="{{ route('paradero.destroy', $paradero) }}" method="POST"
                                                    class="casino formulario">
                                                    @csrf
                                                    @method('DELETE')
                                                    @can('paradero.edit')

                                                    <a href="{{ route('paradero.edit', $paradero) }}" class="bs-tooltip"
                                                        ...
                                                        @endcan
                                                            ...
                                                            <button type="submit"
                                                            class="btn btn-danger {{ $paradero->status == '2' ? 'disabled' : '' }}"
                                        ...
                                        <td class="text-center">
                                            <ul class="table-controls">
                                                <form action="{{ route('paradero.activar', $paradero) }}" method="POST"
                                                    class="casino formulario2">
                                                    @csrf
                                                    @method('POST')
                                                    <button type="submit"
                                                        class="btn btn-success {{ $paradero->status == '1' ? 'disabled' : '' }}"
