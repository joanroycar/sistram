    ...
    <div class="row">
        <div class="col-sm-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::model($resolucion, [
                        'route' => ['resolucion.update', $resolucion],
                        'method' => 'put',
                        'files' => true,
                        'class' => 'formulario',
                    ]) !!}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre"
                            placeholder="Ingrese El Nombre" value="{{ $resolucion->nombre }}">
                        @error('nombre')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="descripcion" class="form-control" id="descripcion" cols="5" rows="5" >{{ $resolucion->descripcion }}</textarea>
                    ...
                    <a href="{{ route('resolucion.index') }}" class="btn btn-danger">
                        Cancelar
                    </a>                    {!! Form::close() !!}
                </div>
