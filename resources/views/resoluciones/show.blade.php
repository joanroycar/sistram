                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre"
                            placeholder="Ingrese El Nombre" value="{{ $resolucion->nombre }}" disabled>
                        @error('nombre')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="descripcion" class="form-control" id="descripcion" cols="5" rows="5" disabled>{{ $resolucion->descripcion }}</textarea>
                    ...
                    <a href="{{ route('resolucion.index') }}" class="btn btn-danger" style="float:right">
                        Volver a Lista De Resoluciones
                    </a>                    
                </div>
