            ...
            <div class="col-md-12">
                <div class="flex-wrap d-flex justify-content-between align-items-center" style="color: black">
                    ...
                    <div>
                        ...
                        <a href="{{ route('empresa.create') }}" class="btn btn-primary" style="color: white; border-radius: 12px">
                                ...
                                @foreach ($empresas as $empresa)
                                    <tr>
                                        <td>
                                            ...
                                            <a href="{{ route('empresa.show', $empresa) }}"> <svg width="32"
                                        ...
                                        <td>
                                            {{ $empresa->tipo_organizacion->siglas }}             
                                        </td>
                                        ...
                                        <td>{{ $empresa->resolucion->nombre }}</td>
                                        <td>{{$empresa->resolucionnueva->nombre}}</td>
                                        <td class="text-center">
                                            <ul class="table-controls">
                                                    ...
                                                    <a href="{{ route('empresa.edit', $empresa) }}" class="bs-tooltip"
                                                        ...
                                                        @can('empresa.destroy')
                                                            ...
                                                            <button type="submit"
                                                            class="btn btn-danger {{ $empresa->status == '2' ? 'disabled' : '' }}"
                                        ...
                                        <td class="text-center">
                                            <ul class="table-controls">
                                                <form action="{{ route('empresa.activar', $empresa) }}" method="POST"
                                                    class="casino formulario2">
                                                    @csrf
                                                    @method('POST')
                                                    <button type="submit"
                                                        class="btn btn-success {{ $empresa->status == '1' ? 'disabled' : '' }}"
