                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre"
                            placeholder="Ingrese El Nombre" value="{{ $zona->nombre }}">
                        @error('nombre')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="descripcion" class="form-control" id="descripcion" cols="5" rows="5" >{{ $zona->descripcion }}</textarea>
                    ...
                    <a href="{{ route('zona.index') }}" class="btn btn-danger">
                        Cancelar
                    </a>                    {!! Form::close() !!}
                </div>
