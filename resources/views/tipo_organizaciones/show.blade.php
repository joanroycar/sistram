                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre"
                            placeholder="Ingrese El Nombre" value="{{ $tipoOrganizacion->nombre }}" disabled>
                        @error('nombre')
                    ...
                    <div class="form-group">
                        ...
                        placeholder="Ingrese las Siglas" value="{{ $tipoOrganizacion->siglas  }}" disabled>
                        @error('siglas')
                            <strong class="text-sm text-red-600" style="color: red">{{ $message }}</strong>
                        @enderror
                    </div>

                    <a href="{{ route('tipo-organizacion.index') }}" class="btn btn-danger" style="float: right">
                        Volver a Lista de Tipo De Organizaciones
                    </a>                    
                </div>
