        ...
        <div class="row">
            <div class="col-md-12">
                <div class="flex-wrap d-flex justify-content-between align-items-center" style="color: black">
                    <div>
                        <h1>Registrar Tipo Organización</h1>
                    </div>
                    {{-- <div>
    ...
    <div class="row">
        <div class="col-sm-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open(['route' => 'tipo-organizacion.store', 'autocomplete' => 'off', 'files' => true, 'class' => 'formulario']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="siglas" name="siglas"
                            placeholder="Ingrese las Siglas" value="{{ old('siglas') }}">
