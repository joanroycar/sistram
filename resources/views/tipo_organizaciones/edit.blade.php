@section('title', 'Editar Tipo Organizacion')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="flex-wrap d-flex justify-content-between align-items-center" style="color: black">
                    <div>
                        <h1>Editar Tipo Organización</h1>
                    </div>
                    {{-- <div>
    ...
    <div class="row">
        <div class="col-sm-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::model($tipoOrganizacion, [
                        'route' => ['tipo-organizacion.update', $tipoOrganizacion],
                        'method' => 'put',
                        'files' => true,
                        'class' => 'formulario',
                    ]) !!}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre"
                            placeholder="Ingrese El Nombre" value="{{ $tipoOrganizacion->nombre }}">
                        @error('nombre')
                    ...
                    <div class="form-group">
                        <label class="form-label" for="pwd">Siglas:</label>
                        <input type="text" class="form-control" id="siglas" name="siglas"
                        placeholder="Ingrese las Siglas" value="{{ $tipoOrganizacion->siglas  }}">
                        @error('siglas')
                            <strong class="text-sm text-red-600" style="color: red">{{ $message }}</strong>
                        @enderror
                    </div>
                    ...
                    <a href="{{ route('tipo-organizacion.index') }}" class="btn btn-danger">
                        Cancelar
                    </a>                    {!! Form::close() !!}
                </div>
