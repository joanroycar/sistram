    ...
    <div class="row">
        <div class="col-sm-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::model($vehiculo, [
                        'route' => ['vehiculo.update', $vehiculo],
                        'method' => 'put',
                        'files' => true,
                        'class' => 'formulario',
                    ]) !!}                      
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            {!! Form::select('dueño_id', $personas, null, ['class' => 'form-control']) !!}
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <label class="form-label" for="pwd">Conductor Sustito:</label>
                            {!! Form::select('persona_sustituida_id', $personas, null, ['class' => 'form-control']) !!}
                            @error('persona_id')
                                <strong class="text-sm text-red-600" style="color: red">{{ $message }}</strong>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="placa" name="placa"
                                placeholder="Ingrese El numero de placa" value="{{$vehiculo->placa}}">
                            @error('placa')
                                <strong class="text-sm text-red-600" style="color: red">{{ $message }}</strong>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label" for="pwd">N° Placa Sustituta:</label>
                            <input type="text" class="form-control" id="placa_sustituida" name="placa_sustituida"
                                placeholder="Ingrese El numero de placa" value="{{$vehiculo->placa_sustituida}}">
                            @error('placa_sustituida')
                                <strong class="text-sm text-red-600" style="color: red">{{ $message }}</strong>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="numero_flota" name="numero_flota"
                                placeholder="Ingrese El N° De Flota" value="{{$vehiculo->numero_flota}}" onkeypress="return solonumeros(event)">
                            @error('numero_flota')
                                <strong class="text-sm text-red-600" style="color: red">{{ $message }}</strong>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="serie_motor" name="serie_motor"
                                    ...
                                    placeholder="Ingrese la Serie De Motor" value="{{$vehiculo->serie_motor}}">                       
                                     @error('serie_motor')
                                    <strong class="text-sm text-red-600" style="color: red">{{ $message }}</strong>
                                @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="carnet_seguridad_vial" name="carnet_seguridad_vial"
                                    ...
                                    placeholder="Ingrese el N° De Seguridad Vial" value="{{$vehiculo->carnet_seguridad_vial}}" onkeypress="return solonumeros(event)">                       
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" name="soat" id="soat"
                                     value="{{old('soat',1)}}" {{ $vehiculo->soat == '1' ? 'checked' : '' }}>
                            <label for="radio1" class="form-check-label pl-2">VIGENTE</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" name="soat" id="pubicacion" value="{{old('soat',2)}}" {{ $vehiculo->soat == '2' ? 'checked' : '' }}>
