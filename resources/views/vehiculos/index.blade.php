            ...
            <div class="col-md-12">
                <div class="flex-wrap d-flex justify-content-between align-items-center" style="color: black">
                    ...
                    <div>
                        ...
                        <a href="{{ route('vehiculo.create') }}" class="btn btn-primary" style="color: white; border-radius: 12px">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title"> Lista De Vehiculo </h4>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                @foreach ($vehiculos as $vehiculo)
                                    <tr>
                                        <td>
                                            {{ $vehiculo->id}}
                                            @can('vehiculo.show')
                                            <a href="{{ route('vehiculo.show', $vehiculo) }}"> <svg width="32"
                                        ...
                                        <td>
                                            {{ $vehiculo->personas->nombres}}</td>
                                            <td>
                                                {{ $vehiculo->propietario->nombres}}</td>
                                        <td>{{ $vehiculo->placa}}</td>
                                        <td>
                                            {{ $vehiculo->numero_flota}}</td>

                                        <td>{{ $vehiculo->serie_motor}}</td>

                                        <td class="text-center">
                                            {{ $vehiculo->carnet_seguridad_vial}}</td>


                                        <td>
                                            @if($vehiculo->soat == 1)
                                            <p class="btn btn-success rounded-pill">VIGENTE</p>
                        
                                            @else
                                            <p class="btn btn-danger rounded-pill">NO VIGENTE</p>
                                        ...
                                        <td>
                                            ...
                                            <p class="btn btn-success rounded-pill">FUNCIONANDO</p>
                                            @else
                                            <p class="btn btn-danger rounded-pill">DADO DE BAJA</p>
                                            @endif
                                        </td> 
                                        ...
                                        <td class="text-center">
                                            <ul class="table-controls">
                                                    ...
                                                    @method('DELETE')
                                                    @can('vehiculo.edit')
                                                    <a href="{{ route('vehiculo.edit', $vehiculo) }}" class="bs-tooltip"
                                                        ...
                                                        @can('vehiculo.destroy')
                                                            <button type="submit"
                                                            class="btn btn-danger {{ $vehiculo->status == '2' ? 'disabled' : '' }}"
                                        ...
                                        <td class="text-center">
                                            <ul class="table-controls">
                                                <form action="{{ route('vehiculo.activar', $vehiculo) }}" method="POST"
                                                    class="casino formulario2">
                                                    @csrf
                                                    @method('POST')
                                                    <button type="submit"
                                                        class="btn btn-success {{ $vehiculo->status == '1' ? 'disabled' : '' }}"
