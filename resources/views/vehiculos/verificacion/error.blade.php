...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <!-- Favicon -->
      <link rel="shortcut icon" type="image/x-icon" href="{{asset('images/muni_logo.png')}}" >
  ...
  <body class=" " data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
    ...
    <div class="container-fluid p-0">
        <div class="iq-maintenance text-center"> 
            <img src="/images/error/01.png" class="img-fluid mb-4" alt="">            
                ...
                <div class="bg-primary" style="background: transparent; height: 320px;">
                    <div class="gradient-bottom">
                        <div class="bottom-text general-zindex">
                            <h1 class="mb-2 text-white">No se encuentra habilitado contactarse pronto</h1>
                            <p>Para la pronta habilitación debe tener en cuenta que todo debe estar en regla.</p>
